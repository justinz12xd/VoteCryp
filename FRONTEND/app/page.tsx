...
import { Shield, Network, Lock, Zap, Wallet, Code } from "lucide-react";
          ...
          <div className="space-y-6">
            ...
            <div className="mt-4">
              <h4 className="text-sm font-semibold">
                Connect your wallet (demo)
              </h4>
              <div className="flex gap-2 mt-2 max-w-sm">
                <Input
                  placeholder="your-name.eth (optional)"
                  value={ensName}
                  onChange={(e) => setEnsName(e.target.value)}
                />
                <Button disabled title="Connection handled by backend">
                  <Wallet className="h-4 w-4 mr-2" />
                  Connect
                </Button>
              </div>
              <p className="text-xs text-muted-foreground mt-2">
                The real connection is handled by the backend in this demo.
              </p>
            </div>
          </div>
